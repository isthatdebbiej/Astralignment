...
export function StageCamera({ onVideoReady, onCalibration }: StageCameraProps) {
  ...
  async function saveCalibration() {
    if (!window.confirm('Confirm these are measured physical dimensions and correctly ordered floor corners. Applying them updates the stage and invalidates prior scene results.')) return;
    try {
